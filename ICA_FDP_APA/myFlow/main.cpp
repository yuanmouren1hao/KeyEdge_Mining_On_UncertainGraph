...
int _tmain(int argc, char* argv[])
{
	...
	/*
	char argv1[BUFFER_SIZE]="data\\st\\V6E10s-t_3.txt";
	char argv2[BUFFER_SIZE]="data\\graph\\V6E10_3.txt";
	char argv3[BUFFER_SIZE]="data\\results\\V6E10_3.txt";
	...
	*/
	...
	while(inReader.ReadGraph(g))                               /*读取文件中的图*/
	{
		...
		//核心算法
		computeICA_APA(&StateMtrix, &key_edge_set, g, s, t);
